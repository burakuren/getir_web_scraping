...
def getir_to_excel_first_call():
    ...
    url_list = ["https://getir.com/yemek/restoran/cosa-bi-corba-bi-salata-kozyatagi-mah-kadikoy-istanbul/"]
    url_list1 = ["https://getir.com/yemek/restoran/konoha-bagdat-cad-kadikoy-istanbul/"]

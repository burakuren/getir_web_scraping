...
def getir_to_excel_first():
    ...
    for url_key in url_dict.keys():
        ...
        if close == None:            
            ...
            ws.append([url_key, date, "AÇIK" , current_rating])
        ...
        #TODO: This is gonna be canceled because we are not going to calculate the current OPEN/CLOSE status with this
            ...
            ws.append([url_key ,date, "KAPALI" , current_rating])
...
def get_name(soup):
    ...
    url_key = s1.find("h1", class_="style__Title1-sc-__sc-1nwjacj-2 hIkhWh sc-7047f3e2-2 hAeUHj")
